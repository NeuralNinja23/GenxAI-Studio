...
from app.topology.structural_diff import StructuralDiff
from app.topology.topology_builder import TopologyBuilder
from app.topology.topology_version_manager import TopologyVersionManager, TopologyVersionRecord
...
async def test_ast_mutator_surgical():
    ...
    from app.topology.ast_generator import ASTFile, ASTClass, ASTMethod
...
async def test_ast_merging():
    ...
    from app.topology.ast_generator import ASTFile, ASTClass, ASTField
    from app.topology.ast_merger import ASTMerger
...
async def test_ast_validation_physics():
    ...
    from app.topology.ast_generator import ASTFile, ASTImport
...
async def test_ast_projector_flow():
    ...
    from app.topology.ast_projector import ASTProjector
...
async def test_oracle_pipeline_integration():
    ...
    from app.oracles.pipeline import OraclePipeline
    from app.governance.evidence_registry import EvidenceRegistry, EvidenceRecord
...
async def test_runtime_projection_validator_parity():
    ...
    from app.runtime.runtime_projection_validator import RuntimeProjectionValidator
    from app.topology.topology_version_manager import TopologyVersionManager
...
async def test_reality_sync_synchronize():
    ...
    from app.runtime.reality_sync import RealitySync
...
async def test_reality_sync_collapse_and_freeze():
    ...
    from app.runtime.reality_sync import RealitySync, RealityDivergenceCollapse
...
async def test_forensic_reconstruction():
    ...
    from app.runtime.reconstruction import ForensicReconstruction
