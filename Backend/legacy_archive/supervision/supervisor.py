...
async def supervised_agent_call(
    ...
    from app.arbormind.agents.capabilities import validate_agent_capability
    import os

    # Validate agent capability before execution
    validate_agent_capability(agent_name, step_name)
