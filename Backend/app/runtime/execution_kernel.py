...
Separation of concerns (from implementation plan):
    ...
    │  arbor_core, branch, mutation_engine, faculties        │
    └───────────────┬───────────────────────────────────────┘
...
from app.runtime.drift_detection import DriftDetector, DriftResponse, DriftSeverity
...
from app.runtime.projection_snapshots import SnapshotManager
from app.runtime.transaction_engine import TransactionEngine
