...
The Sensory Grounding Cortex of Sentinel.
...
class RuntimeProjectionValidator:
    ...
    async def validate_parity(cls, project_id: str, project_path: Path) -> ParityReport:
        ...
        from app.sentinel.runtime.projection_snapshots import TRACKED_EXTENSIONS, EXCLUDED_DIRS
        ...
        from app.sentinel.runtime.drift_detection import CRITICAL_PATH_SEGMENTS
