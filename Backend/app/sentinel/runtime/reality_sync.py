...
from app.sentinel.runtime.runtime_projection_validator import RuntimeProjectionValidator, ParityReport
...
from app.sentinel.runtime.leases import LeaseManager
...
class RealitySync:
    ...
    async def synchronize_reality(cls, project_id: str, project_path: Path, active_lease_id: Optional[str] = None) -> RealitySyncResult:
        ...
        from app.sentinel.runtime.drift_detection import DriftDetector
